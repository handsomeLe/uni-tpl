	...
	export default {
		...
		data() {
			return {
				...
				listTop__: 40,       // 列表框的top位置，在初始时，根据input节点的高度来调整
			};
		},
...
<style scoped lang="scss">
	...
	.show-box{
		...
		.right-arrow{
			...
			top: 0;
			align-items: center; color: #c0c4cc; height: 100%;
			font-weight: 100; width: 12%; justify-content: center;
		}
		.clear{
			color: #fff;  line-height: 1; 
			font-size: 24rpx;
			background-color: #c0c4cc; border-radius: 50%;  padding: 2px;
		}
		
		/****** 列表框部分样式 *****/
		.list-container{
			position: absolute; width: 100%; left: 0; top: 40px;
